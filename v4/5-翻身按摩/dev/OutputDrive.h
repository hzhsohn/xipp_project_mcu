...
#define REL_3_STATE(x) (!x)?GPIO_SetBits(REL_3_GPIO,REL_3_PIN):GPIO_ResetBits(REL_3_GPIO,REL_3_PIN)
#define REL_4_STATE(x) (!x)?GPIO_SetBits(REL_4_GPIO,REL_4_PIN):GPIO_ResetBits(REL_4_GPIO,REL_4_PIN)

#define REL_L1_STATE(x) (!x)?GPIO_SetBits(REL_L1_GPIO,REL_L1_PIN):GPIO_ResetBits(REL_L1_GPIO,REL_L1_PIN)
#define REL_L2_STATE(x) (!x)?GPIO_SetBits(REL_L2_GPIO,REL_L2_PIN):GPIO_ResetBits(REL_L2_GPIO,REL_L2_PIN)
#define REL_L3_STATE(x) (!x)?GPIO_SetBits(REL_L3_GPIO,REL_L3_PIN):GPIO_ResetBits(REL_L3_GPIO,REL_L3_PIN)
#define REL_L4_STATE(x) (!x)?GPIO_SetBits(REL_L4_GPIO,REL_L4_PIN):GPIO_ResetBits(REL_L4_GPIO,REL_L4_PIN)
#define REL_L5_STATE(x) (!x)?GPIO_SetBits(REL_L5_GPIO,REL_L5_PIN):GPIO_ResetBits(REL_L5_GPIO,REL_L5_PIN)
#define REL_L6_STATE(x) (!x)?GPIO_SetBits(REL_L6_GPIO,REL_L6_PIN):GPIO_ResetBits(REL_L6_GPIO,REL_L6_PIN)
#define REL_L7_STATE(x) (!x)?GPIO_SetBits(REL_L7_GPIO,REL_L7_PIN):GPIO_ResetBits(REL_L7_GPIO,REL_L7_PIN)
#define REL_L8_STATE(x) (!x)?GPIO_SetBits(REL_L8_GPIO,REL_L8_PIN):GPIO_ResetBits(REL_L8_GPIO,REL_L8_PIN)
#define REL_L9_STATE(x) (!x)?GPIO_SetBits(REL_L9_GPIO,REL_L9_PIN):GPIO_ResetBits(REL_L9_GPIO,REL_L9_PIN)
#define REL_L10_STATE(x) (!x)?GPIO_SetBits(REL_L10_GPIO,REL_L10_PIN):GPIO_ResetBits(REL_L10_GPIO,REL_L10_PIN)
#define REL_L11_STATE(x) (!x)?GPIO_SetBits(REL_L11_GPIO,REL_L11_PIN):GPIO_ResetBits(REL_L11_GPIO,REL_L11_PIN)
#define REL_L12_STATE(x) (!x)?GPIO_SetBits(REL_L12_GPIO,REL_L12_PIN):GPIO_ResetBits(REL_L12_GPIO,REL_L12_PIN)

#define REL_R1_STATE(x) (!x)?GPIO_SetBits(REL_R1_GPIO,REL_R1_PIN):GPIO_ResetBits(REL_R1_GPIO,REL_R1_PIN)
#define REL_R2_STATE(x) (!x)?GPIO_SetBits(REL_R2_GPIO,REL_R2_PIN):GPIO_ResetBits(REL_R2_GPIO,REL_R2_PIN)
#define REL_R3_STATE(x) (!x)?GPIO_SetBits(REL_R3_GPIO,REL_R3_PIN):GPIO_ResetBits(REL_R3_GPIO,REL_R3_PIN)
#define REL_R4_STATE(x) (!x)?GPIO_SetBits(REL_R4_GPIO,REL_R4_PIN):GPIO_ResetBits(REL_R4_GPIO,REL_R4_PIN)
#define REL_R5_STATE(x) (!x)?GPIO_SetBits(REL_R5_GPIO,REL_R5_PIN):GPIO_ResetBits(REL_R5_GPIO,REL_R5_PIN)
#define REL_R6_STATE(x) (!x)?GPIO_SetBits(REL_R6_GPIO,REL_R6_PIN):GPIO_ResetBits(REL_R6_GPIO,REL_R6_PIN)
#define REL_R7_STATE(x) (!x)?GPIO_SetBits(REL_R7_GPIO,REL_R7_PIN):GPIO_ResetBits(REL_R7_GPIO,REL_R7_PIN)
#define REL_R8_STATE(x) (!x)?GPIO_SetBits(REL_R8_GPIO,REL_R8_PIN):GPIO_ResetBits(REL_R8_GPIO,REL_R8_PIN)
#define REL_R9_STATE(x) (!x)?GPIO_SetBits(REL_R9_GPIO,REL_R9_PIN):GPIO_ResetBits(REL_R9_GPIO,REL_R9_PIN)
#define REL_R10_STATE(x) (!x)?GPIO_SetBits(REL_R10_GPIO,REL_R10_PIN):GPIO_ResetBits(REL_R10_GPIO,REL_R10_PIN)
#define REL_R11_STATE(x) (!x)?GPIO_SetBits(REL_R11_GPIO,REL_R11_PIN):GPIO_ResetBits(REL_R11_GPIO,REL_R11_PIN)
#define REL_R12_STATE(x) (!x)?GPIO_SetBits(REL_R12_GPIO,REL_R12_PIN):GPIO_ResetBits(REL_R12_GPIO,REL_R12_PIN)
