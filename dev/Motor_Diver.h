...
#define TOUCHKEY_1_STATE() 							GPIO_ReadInputDataBit(MOTOR1_LIMIT_GPIO,MOTOR1_LIMIT_PIN)
#define TOUCHKEY_2_STATE() 							GPIO_ReadInputDataBit(MOTOR2_LIMIT_GPIO,MOTOR2_LIMIT_PIN)
