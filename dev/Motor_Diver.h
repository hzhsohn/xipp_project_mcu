...
#define MOTOR1_C_GPIO 	GPIOE
#define MOTOR1_C_PIN  	GPIO_Pin_7
...
#define MOTOR1_C_STATE(x) (x)>0?GPIO_SetBits(MOTOR1_C_GPIO,MOTOR1_C_PIN):GPIO_ResetBits(MOTOR1_C_GPIO,MOTOR1_C_PIN)
#define MOTOR1_D_STATE(x) (x)>0?GPIO_SetBits(MOTOR1_D_GPIO,MOTOR1_D_PIN):GPIO_ResetBits(MOTOR1_D_GPIO,MOTOR1_D_PIN)
